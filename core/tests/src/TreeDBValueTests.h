...
{
public:
    TreeDBValueTests(const Ishiko::Tests::TestNumber& number, const Ishiko::Tests::TestContext& context);

private:
    static void ConstructorTest1(Ishiko::Tests::Test& test);
    static void Int8Test1(Ishiko::Tests::Test& test);
    static void Int32Test1(Ishiko::Tests::Test& test);
    static void UnsignedInt64Test1(Ishiko::Tests::Test& test);
    ...
    static void SetUnsignedInt64Test1(Ishiko::Tests::Test& test);
